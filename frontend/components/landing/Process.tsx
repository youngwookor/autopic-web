...
const ProcessCard = ({ step, title, desc, icon: Icon, children }: ProcessCardProps) => {
  return (
    <div className="relative bg-zinc-50 rounded-2xl md:rounded-[32px] p-5 md:p-6 lg:p-8 flex flex-col items-center text-center group hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-zinc-200 overflow-hidden h-full">
      {/* Step Number */}
...
export default function Process() {
  return (
    <section id="process" className="py-16 md:py-24 bg-white px-4 md:px-6">
